$(function() {
    ...
    $("input,select").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            var flatnumber = $("input#flatnumber").val();
            var purpose = $("select#purpose").val();
            var frequentvisitor = $("input[type='radio']:checked#frequentvisitor").val();
            ...
            $.ajax({
                url: "visitorregistration/visitordetailssubmit.php",
                type: "POST",
                data: {
                    name: name,
                    address: address,
                ...
                success: function() {
                    ...
                    $('#success > .alert-success')
                        .append("<strong>Your entry is successfully registered. </strong>");
                    $('#success > .alert-success')
                        .append('</div>');
