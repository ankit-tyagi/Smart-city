...
class User
{
	...
	function __construct($user,$display,$car,$mobile,$pass,$email)
	{
	...
	public function userCakeAddUser()
	{
		...
		if($this->status)
		{
			...
			if(!$this->mail_failure)
			{
				...
				$stmt->bind_param("sssssssi", $this->username, $this->displayname, $this->user_car, $this->user_mobile, $secure_pass, $this->clean_email, $this->activation_token, $this->user_active);
				$stmt->execute();
