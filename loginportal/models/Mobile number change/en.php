...
$lang = array_merge($lang,array(
	"INVALID_MOBILENUMBER"			=> "Mobile number must be an integer",
	"CAR_NUMBER_CHAR_LIMIT"		    => "Your CARNUMBER must be between %m1% and %m2% characters in length",
	...
	"CAR_NUMBER_INVALID_CHARACTERS"	=> "CAR NUMBER  can only include alpha-numeric characters",
	"ACCOUNT_USERNAME_IN_USE"		=> "Username %m1% is already in use",
	"CAR_NUMBER_IN_USE"				=> "CARNUMBER %m1% is already in use",
	"ACCOUNT_DISPLAYNAME_IN_USE"		=> "Display name %m1% is already in use",
	"ACCOUNT_MOBILE_IN_USE"			=> "Mobile %m1% is already in use",
	...
	"ACCOUNT_MOBILE_UPDATED"			=> "Account Mobile Number updated",
